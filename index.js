...
app.post("/start-bot", (req, res) => {
  ...
  try {
    ...
    fs.writeFileSync(
      path.join(userDir, "appstate.json"),
  ...
  const child = fork(path.join(__dirname, "bot.js"), [String(admin)], {
    silent: true,
  });
...
setInterval(() => console.log("🟢 Keepalive ping"), 15000);

// ---- Start ----
server.listen(PORT, () =>
  console.log(`🚀 ANURAG PANEL running on http://localhost:${PORT}`)
);
